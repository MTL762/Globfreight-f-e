...
//               "dark:text-primary": themes.includes("dark") && unreadCount > 0
//             })}
//           />
//           {unreadCount > 0 && (
//             <Badge
...
//           sideOffset={8}
//           collisionPadding={16}
//           className="bg-popover text-popover-foreground z-[100] w-[calc(100vw-32px)] sm:w-[380px] rounded-md border p-0 shadow-md outline-none"
